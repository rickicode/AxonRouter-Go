...
| Task # | 1 |
| Branch | hive/02_settings-https-tls/01-add-https-config-model-and-yaml-loader |
| Worktree | /workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/01-add-https-config-model-and-yaml-loader |

**CRITICAL**: All file operations MUST be within this worktree path:
`/workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/01-add-https-config-model-and-yaml-loader`
