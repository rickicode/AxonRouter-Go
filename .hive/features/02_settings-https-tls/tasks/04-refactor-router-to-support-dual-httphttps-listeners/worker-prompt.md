...
| Task # | 4 |
| Branch | hive/02_settings-https-tls/04-refactor-router-to-support-dual-httphttps-listeners |
| Worktree | /workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/04-refactor-router-to-support-dual-httphttps-listeners |

**CRITICAL**: All file operations MUST be within this worktree path:
`/workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/04-refactor-router-to-support-dual-httphttps-listeners`
