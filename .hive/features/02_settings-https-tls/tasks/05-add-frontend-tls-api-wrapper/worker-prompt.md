...
| Task # | 5 |
| Branch | hive/02_settings-https-tls/05-add-frontend-tls-api-wrapper |
| Worktree | /workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/05-add-frontend-tls-api-wrapper |

**CRITICAL**: All file operations MUST be within this worktree path:
`/workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/05-add-frontend-tls-api-wrapper`
