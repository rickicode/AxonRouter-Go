...
| Task # | 6 |
| Branch | hive/02_settings-https-tls/06-redesign-settingssvelte-with-tabs |
| Worktree | /workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/06-redesign-settingssvelte-with-tabs |

**CRITICAL**: All file operations MUST be within this worktree path:
`/workspaces/AxonRouter-GO/.hive/.worktrees/02_settings-https-tls/06-redesign-settingssvelte-with-tabs`
