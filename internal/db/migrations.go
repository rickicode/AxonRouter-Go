...
`)
	...
	providers := []struct {
		...
		{"iflow", "iFlow", "openai", "https://apis.iflow.cn/v1/chat/completions", "oauth", []string{"llm"}},
		{"gitlab", "GitLab Duo", "openai", "https://gitlab.com/api/v4/chat/completions", "oauth", []string{"llm"}},
		{"xai", "xAI (Grok)", "openai", "https://api.x.ai/v1/chat/completions", "oauth", []string{"llm"}},
