...
func RegisterDefaults() {
	...
	for _, p := range []string{"openai", "groq", "deepseek", "oc", "oc-zen", "oc-go", "mimo", "mimo-tp", "elevenlabs", "deepgram", "glm", "minimax", "kimi", "mistral", "cerebras", "together", "fireworks", "novita", "lambda", "pollinations", "zenmux", "zenmux-free", "cursor", "fal", "black-forest-labs", "assemblyai", "edge-tts", "cartesia"} {
	...
	for _, p := range []string{
		...
		"qwencloud", "cursor", "fal", "black-forest-labs", "assemblyai", "edge-tts", "cartesia",
	} {
