...
var Registry = map[string]CanonicalInfo{
	...
	"black-forest-labs": {DisplayName: "Black Forest Labs", Aliases: []string{"blackforestlabs", "black_forest_labs"}},
	"assemblyai":        {DisplayName: "AssemblyAI", Aliases: []string{"assembly-ai"}},
	"edge-tts":          {DisplayName: "Edge TTS", Aliases: []string{"edgetts"}},
