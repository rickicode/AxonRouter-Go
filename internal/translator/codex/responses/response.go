...
func convertCodexResponseToOpenAIStream(_ context.Context, _ string, _, _ []byte, rawChunk []byte, param *any) [][]byte {
...
// convertCodexResponseToOpenAINonStream converts a complete Codex Responses response to OpenAI format.
func convertCodexResponseToOpenAINonStream(_ context.Context, _ string, _, _ []byte, rawResponse []byte, _ *any) []byte {
