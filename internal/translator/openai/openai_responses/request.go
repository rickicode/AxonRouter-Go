...
// convertOpenAIRequestToCodexResponses converts OpenAI Chat Completions to Codex Responses format.
func convertOpenAIRequestToCodexResponses(modelName string, body []byte, stream bool) []byte {
