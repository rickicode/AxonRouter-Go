...
<a href="/" class="flex items-center gap-3 group px-3 py-1" aria-label="AxonRouter Dashboard">
  ...
  <div class="flex flex-col min-w-0">
    <span class="font-semibold text-[14px] text-foreground block truncate tracking-[-0.03em] leading-tight">
      AxonRouter
    </span>
    <span class="text-[10px] font-mono text-muted-foreground tracking-wider uppercase">
      Dashboard
    </span>
  </div>
</a>
