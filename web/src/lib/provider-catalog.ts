  ...
  },
{
  ...
  },
  {
    ...
    textIcon: 'GL',
    category: 'oauth',
    description: 'GitLab Duo via OAuth authorization-code + PKCE flow. Requires a GitLab OAuth application (client ID/secret); set GITLAB_OAUTH_CLIENT_ID (and GITLAB_OAUTH_BASE_URL for self-hosted).',
    format: 'openai',
    authType: 'oauth',
    prefix: 'gitlab/',
    isBuiltIn: true,
    ...
    color: '#FC6D26',
    serviceKinds: ['llm'],
    authHint: 'Create an OAuth application in GitLab (scope: api read_user) and set GITLAB_OAUTH_CLIENT_ID / GITLAB_OAUTH_CLIENT_SECRET.',
  },
  {
    id: 'xai',
    ...
    textIcon: 'XA',
    category: 'oauth',
    description: 'xAI Grok via OAuth authorization-code + PKCE flow with OIDC discovery. Routes to the xAI API (grok-cli:access + api:access scopes).',
    format: 'openai',
    authType: 'oauth',
    prefix: 'xai/',
    isBuiltIn: true,
  ...
  },
  {
    ...
    textIcon: 'IF',
    category: 'oauth',
    description: 'iFlow AI via OAuth authorization-code flow (phone login). The provider-scoped apiKey from the user-info exchange signs every request (HMAC-SHA256).',
    format: 'openai',
    authType: 'oauth',
    prefix: 'iflow/',
    isBuiltIn: true,
