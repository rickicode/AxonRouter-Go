...
export const PROVIDER_CATALOG: ProviderMeta[] = [
  ...
  },
  {
    ...
    category: 'oauth',
    description: 'GitHub Copilot OAuth-token provider. The current UI exposes a token input field because AxonRouter does not yet ship a GitHub device-code OAuth service; paste the Copilot OAuth Bearer token here.',
    format: 'openai',
    authType: 'apikey',
    prefix: 'copilot/',
    isBuiltIn: true,
